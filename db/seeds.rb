...
review1 = Review.create!(content:"very good", user_id: jean.id)
review2 = Review.create!(content:"so fast, I save my day", user_id: jean.id)
review3 = Review.create!(content:"a very nice saver and very efficient !", user_id: lauren.id)
review4 = Review.create!(content:"Sooooo nice !", user_id: lauren.id)
